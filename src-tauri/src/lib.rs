...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::plugins_scan,
            commands::plugins_cli_available,
            commands::plugins_set_enabled,
            commands::plugins_install,
            commands::plugins_uninstall,
            commands::plugins_marketplace_add,
            commands::plugins_marketplace_update,
            commands::settings_catalog,
            commands::settings_set,
            commands::settings_unset,
            commands::settings_schema_diff,
            commands::settings_env_list,
