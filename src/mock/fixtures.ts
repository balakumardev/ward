...
export const codexScan: ScanResult = {
  ...
  capabilities: { contextBudget: false, mcpControls: true, mcpPolicy: false, mcpSecurity: true, sessions: false, effective: false, backup: true, mcpEditable: true, skillCreatable: true, pluginsManageable: false, settingsEditable: false },
};
